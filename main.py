...
button_wrong = Button(image=button_image_wrong, highlightthickness=0, bg=BACKGROUND_COLOR)
button_wrong.grid(row=1, column=0)
button_right = Button(image=button_image_right, highlightthickness=0, bg=BACKGROUND_COLOR)
